    ...
    <div className=" my-8 flex justify-center h-fit  items-center flex-col w-screen lg:w-1/2  p-3 sm:p-1 sm:py-4 shadow rounded-2xl">
      ...
      <form className="sm:w-2/3 w-full flex flex-col" onSubmit={onSubmit}>
        ...
        <label className="flex relative flex-col">
          ...
          <textarea
            spellCheck={true}
            className=" p-3 pr-8 sm:pr-6 h-[250px] focus:border-main hover:border-main  overflow-y-scroll resize-none"
        ...
        <div className="flex my-2 flex-wrap justify-between items-center ">
          <label className="relative my-2 ">
            ...
            <select {...register('private', { required: true })}>
          ...
          <label className="relative my-2 ">
            ...
            <select {...register('openSource', { required: true })}>
        ...
        <label className="flex relative f flex-col">
          ...
          <textarea
            className="p-3 pr-6 h-[200px] focus:border-main hover:border-main  overflow-y-scroll resize-none "
            {...register('uses', {
